function desktop(){
  ...
  let layoutStyle = {
    ...
    rootchildFirstdiv: ["100%", "100%", "", "", "", "", "7%","1px solid blue"],
    xpenfl: ["18%", "100%", "flex", "", "center", "center", ""], //테두리
    xpenflmain: ["64%", "100%"], //테두리안에 내용
    spicklayout: ["4%", "10%"],
    homebtn: ["65%", "43%", "flex", "", "center", "center", "50%"],
    homebtnchild: ["65%", "43%", "flex", "", "center", "center", ""],
